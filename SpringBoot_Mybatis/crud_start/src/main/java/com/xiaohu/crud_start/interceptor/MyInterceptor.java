package com.xiaohu.crud_start.interceptor;
...
public class MyInterceptor {
    @Pointcut("within (com.xiaohu.crud_start.controller..*) && !within(com.xiaohu.crud_start.controller.admin.LoginController)")
